document.addEventListener("DOMContentLoaded", function() {
    ...
    const c = function(t, e) {
        ...
        if (t) {
            ...
            let n = [""];
            "dark-contrast" != t && "light-contrast" != t || (n = ["h1", "h2", "h3", "h4", "h5", "h6", "p", "i", "svg", "a", "button", "label", "li", "ol"]);
        ...
        let e = [{
            ...
            id: "readable-font",
            childrenSelector: ["", "h1", "h2", "h3", "h4", "h5", "h6", "p", "i", "svg", "a", "button", "label", "li", "ol"],
    ...
    const h = function(e, s) {
        let a = !1;
        !s && e && (a = e.currentTarget, s = parseFloat(t.states.fontSize) || 1, a.classList.contains("asw-minus") ? s -= .1 : s += .1, s = Math.max(s, 0.8), s = Math.min(s, 1.2), s = parseFloat(s.toFixed(2))), document.querySelectorAll("h1,h2,h3,h4,h5,h6,dl,dt,li,ol,th,td,span").forEach((function(t) {
