...
INSERT INTO `categoria` VALUES (1,'Extintores','El extintor es un artefacto cuya finalidad es apagar los principios de fuego de manera rápida y eficaz.'),(2,'Camillas de emergencia','La camilla de rescate o también conocida como de emergencias es un sistema de transporte, traslado y evacuación de personas heridas o que necesitan ser atendidas por causa de un accidente.'),(3,'Conos de seguridad','Un cono de seguridad es un dispositivo cónico, generalmente naranja, usado para señalizar zonas de riesgo.');
...
INSERT INTO `cliente` VALUES (1,'PN','Ruben Dario Martinez','CC','1116552386','dario564@hotmail.es','3176709994','Transversal 36 km  + 845',1),(2,'PJ','Empresa nacional de distribucion de EPP','NIT','900851850-9','contacto@distribucionepp.com','3128527451','Carrera 15 # 15-80',2);
...
INSERT INTO `compras` VALUES (1,'Adso26','2024-10-11',1),(2,'345','2024-10-11',1),(3,'Adso10','2024-10-11',2);
...
INSERT INTO `detallecompra` VALUES (1,'124',25,280000.00,19.00,8330000.00,1,1),(2,'124',1,45000.00,19.00,53550.00,1,2),(3,'124',24,5000.00,19.00,142800.00,1,3),(4,'Adso10',5,35800.00,19.00,213010.00,3,1);
...
INSERT INTO `detalleventa` VALUES (1,12,38500.00,19,549780.00,'Adso96',1,1),(2,10,39850.00,19,474215.00,'Conal',1,2);
...
INSERT INTO `django_session` VALUES ('bbhpdclltpjc8g0bbrcexkg3nonqrqsd','.eJxVjEEOwiAQRe_C2pBOC1hcuvcMZJgZpGogKe3KeHfbpAvd_vfef6uA65LD2mQOE6uLMur0u0Wkp5Qd8APLvWqqZZmnqHdFH7TpW2V5XQ_37yBjy1vtvRldYqBzTA7ESRyIRvYGDFjnE2DCAR13vUWxZDe3A8LUoxEmy-rzBfk7OPQ:1szIhL:5ahmRosUy-LcXtK3oCPthBCpCHrIP9cnwMabi3gd0kM','2024-10-25 16:41:03.238428');
...
INSERT INTO `normativa` VALUES (1,'NTC 5639','Especificaciones para camillas y otros equipos para el transporte del paciente utilizados en ambulacias terrestres.',2),(2,'NTC 1461','Esta norma tiene por objeto establecer los colores y señales de seguridad utilizados para la prevención de accidentes y riesgos contra la salud y situaciones de emergencia.',3),(3,'NTC 2885','Establece requisitos para la inspección, selección, compra, instalación y mantenimiento de extinguidores portátiles.',1),(4,'Iso 9001','Normativa',1);
...
INSERT INTO `producto` VALUES (1,'Exintor de 10 lb Agua',1,1),(2,'Camilla de emergencia',2,4),(3,'Cono para trafico',3,5);
...
INSERT INTO `proveedor` VALUES (1,'PN','Karol Barrera','CC','1008518778','karolbarrera093@gmail.com','3229173743','cra 18 bis#5-39',2),(2,'PJ','Molino Sonora','NIT','900810091-9','dario564@hotmail.es','3176709994','Calle 50 # 10-15',1);
...
INSERT INTO `stock` VALUES (1,8,35800.00,1),(2,1,45000.00,2),(3,24,5000.00,3);
...
INSERT INTO `tipo` VALUES (1,'Extintor de Agua','Es adecuado para fuegos de clase A. Nunca debes utilizarlo si hay presencia de corriente eléctrica en el lugar, ya que puede producirse una electrocución.'),(2,'Extintor tipo D','Se trata de un tipo de extintor específico para fuegos que implican metales, como sodio o magnesio.'),(3,'Camillas nido','Están totalmente preparadas para los rescates en una situación compleja y extrema, como los acuáticos o verticales, que necesitan una elevación horizontal del suelo.'),(4,'Camillas cuchara','Su función es levantar a los pacientes del suelo, totalmente inmovilizados.'),(5,'Conos de tráfico estándar','Los conos de tráfico estándar son los más comunes y reconocibles.'),(6,'Conos de tráfico retráctil','Los conos de tráfico retráctiles son versátiles y se utilizan en situaciones en las que es necesario una señalización temporal.');
...
INSERT INTO `ubicacion` VALUES (1,9,13),(2,6,949),(3,9,995),(4,9,426);
...
INSERT INTO `usuario` VALUES ('pbkdf2_sha256$870000$eh4RxnFjxZyAWyg0GpXCdC$QPwomgIfIANt5Db6nDOW+9CYfqwOeLKCDxwhg966clo=',1,'Admin','Grupo ADSO','dario564@hotmail.es',1,1,1,'2024-10-11 16:39:28.757256','superuser'),('pbkdf2_sha256$870000$2hvhIGnZ9nAZtPpqvj32wu$DzaPBFPaYbLVKZlbUJkvLUGjFUdkCj+ugZ4Cyx03vjQ=',2,'Conaldex','Conaldex Boyaca','conaldex@hotmail.com',0,1,1,'2024-10-11 16:38:51.893414','admin'),('pbkdf2_sha256$870000$6tRqeuChXBurDQ7oXvosWc$J52NexJ7tNThyJtGaYNxbYaRqmDTIp71b1TviRd2+B0=',3,'Normal','Normal','normal@hotmail.es',0,0,1,'2024-10-11 16:39:05.825607','usuario'),('pbkdf2_sha256$870000$oQGWlD5baSwp8TD283zj9f$8Y3d1a+d/oLmksZ4zpg2mEXASyZFgreSQvhLxDYYuI8=',4,'Admin1','Dario Mrtinez','dario564@hotmail.ess',0,1,1,'2024-10-11 16:41:03.234867','admin');
...
INSERT INTO `venta` VALUES (1,'Adso96','2024-10-11',1),(2,'Conal','2024-10-11',2);
...
-- Dump completed on 2024-10-12  1:31:34
