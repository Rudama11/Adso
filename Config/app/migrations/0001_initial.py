    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('superuser', 'Superuser'), ('admin', 'Administrador'), ('usuario', 'Usuario normal')], default='admin', max_length=10, verbose_name='Tipo de usuario')),
