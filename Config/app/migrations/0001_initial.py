...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Compras',
            fields=[
                ('num_factura', models.CharField(max_length=20, primary_key=True, serialize=False, verbose_name='Número de Factura')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombres', models.CharField(blank=True, max_length=30, validators=[app.models.validate_nombre], verbose_name='Nombres y apellidos')),
                ...
                ('tipo_usuario', models.CharField(choices=[('admin', 'Administrador'), ('usuario', 'Usuario normal')], default='admin', max_length=10, verbose_name='Tipo de usuario')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.CharField(max_length=200, validators=[django.core.validators.MinLengthValidator(1), app.models.validate_nombre], verbose_name='Descripción')),
