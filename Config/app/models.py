...
class Persona(models.Model):
    ...
    nombres = models.CharField(max_length=30,validators=[MinLengthValidator(3),validate_nombre],verbose_name='Nombres')
    apellidos = models.CharField(max_length=30,validators=[MinLengthValidator(3),validate_nombre],verbose_name='Apellidos')
