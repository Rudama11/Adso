...
urlpatterns = [
    ...
    path('detalle-compras/eliminar/<int:id_Dcompra>/', DetalleCompraListView.as_view(EliminarDcompra=DetalleCompraListView.EliminarDcompra), name='detallecompra_eliminar'),
    path('obtener-datos-producto/', obtener_datos_producto, name='obtener_datos_producto'),
